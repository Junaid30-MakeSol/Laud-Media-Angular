...
@Directive({
  ...
  selector: '[customDigitOnly]',
})
export class CustomDigitOnlyDirective {
  @Input() decimal? = false;
  ...
  constructor(public el: ElementRef, private digitPipe: CustomDigitPipe) {
  ...
  onFocus(value: any) {
    this.el.nativeElement.value = this.digitPipe.parse(value); // opossite of transform
  }

  @HostListener('blur', ['$event.target.value'])
  onBlur(value: any) {
    this.el.nativeElement.value = this.digitPipe.transform(value); // opossite of transform
  }
