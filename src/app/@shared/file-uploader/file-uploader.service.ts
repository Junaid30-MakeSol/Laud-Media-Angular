...
export class FileUploaderService {
  ...
  private _upload(queueObj: FileQueueObject) {
    ...
    form.append('EntityType', this.EntityType.toString());
    form.append('EntityId', this.EntityId.toString());
    // upload file and report progress
    const req = new HttpRequest('POST', environment.serverUrl + '/api/file/upload', form, {
      reportProgress: true,
    });
